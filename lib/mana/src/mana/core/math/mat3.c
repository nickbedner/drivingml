...
mat3 mat_inertia_tensor_coeffs(r32 ix, r32 iy, r32 iz, r32 ixy, r32 ixz, r32 iyz);
mat3 mat3_block_intertia_tensor(vec3 v1, r32 mass);
mat3 mat3_skew_symmetric(vec3 v1);
...
mat3 mat3_mul_scalar(mat3 m1, r32 scalar);
mat3 mat3_add_mat3(mat3 m1, mat3 m2);
mat3 mat3_orientation(mat3 q1);
mat3 mat3_liner_interpolate(mat3 m1, mat3 m2, r32 prop);
