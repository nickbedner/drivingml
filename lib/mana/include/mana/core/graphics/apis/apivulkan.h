...
global const char* const validation_layers[VULKAN_VALIDATION_LAYER_COUNT] = {"VK_LAYER_KHRONOS_validation"};
#define VULKAN_DEVICE_EXTENSION_COUNT 1
global const char* const device_extensions[VULKAN_DEVICE_EXTENSION_COUNT] = {VK_KHR_SWAPCHAIN_EXTENSION_NAME};
...
u32 vulkan_graphics_utils_find_memory_type(struct VkPhysicalDevice_T* physical_device, u32 typeFilter, VkMemoryPropertyFlags properties);
