...
#include "mana/core/graphics/entities/sprite/spritevulkan.h"
#endif
#ifdef DIRECTX_12_API_SUPPORTED
#include "mana/core/graphics/entities/sprite/spritedirectx12.h"
#endif

struct SpriteFunc {
  u8 (*sprite_init)(struct SpriteCommon*, struct APICommon*, struct Shader*, struct Texture*, size_t);
...
#ifdef VULKAN_API_SUPPORTED
global const struct SpriteFunc VULKAN_SPRITE = {sprite_vulkan_init, sprite_vulkan_delete, sprite_vulkan_render, sprite_vulkan_update_uniforms};
#endif
#ifdef DIRECTX_12_API_SUPPORTED
global const struct SpriteFunc DIRECTX_12_SPRITE = {sprite_directx_12_init, sprite_directx_12_delete, sprite_directx_12_render, sprite_directx_12_update_uniforms};
#endif
