...
#define GAMEPAD_LEFT_SHOULDER XINPUT_GAMEPAD_LEFT_SHOULDER
#define GAMEPAD_RIGHT_SHOULDER XINPUT_GAMEPAD_RIGHT_SHOULDER
#define GAMEPAD_LEFT_THUMB XINPUT_GAMEPAD_LEFT_THUMB
#define GAMEPAD_RIGHT_THUMB XINPUT_GAMEPAD_RIGHT_THUMB
...
enum XBOX_CONTROLLER_ACTIONS {
  XBOX_CONTROLLER_ACTION_DPAD_UP = 0,
  XBOX_CONTROLLER_ACTION_DPAD_DOWN,
  XBOX_CONTROLLER_ACTION_DPAD_LEFT,
  XBOX_CONTROLLER_ACTION_DPAD_RIGHT,
  XBOX_CONTROLLER_ACTION_START,
  XBOX_CONTROLLER_ACTION_BACK,
  XBOX_CONTROLLER_ACTION_LEFT_THUMB,
  XBOX_CONTROLLER_ACTION_RIGHT_THUMB,
  XBOX_CONTROLLER_ACTION_LEFT_SHOULDER,
  XBOX_CONTROLLER_ACTION_RIGHT_SHOULDER,
  XBOX_CONTROLLER_ACTION_A,
  XBOX_CONTROLLER_ACTION_B,
  XBOX_CONTROLLER_ACTION_X,
  XBOX_CONTROLLER_ACTION_Y,
  XBOX_CONTROLLER_ACTION_LAST
};
...
struct XboxController {
  ...
  struct Key buttons[XBOX_CONTROLLER_ACTION_LAST];
