...
#ifdef VULKAN_API_SUPPORTED
static const struct SpriteManagerFunc VULKAN_SPRITE_MANAGER = {sprite_manager_vulkan_init_sprite_pool, sprite_manager_vulkan_delete_sprite, sprite_manager_vulkan_add_sprite, sprite_manager_vulkan_init_sprite_animation_pool, sprite_manager_vulkan_delete_sprite_animation, sprite_manager_vulkan_add_sprite_animation};
#endif
#ifdef DIRECTX_12_API_SUPPORTED
static const struct SpriteManagerFunc DIRECTX_12_SPRITE_MANAGER = {sprite_manager_directx_12_init_sprite_pool, sprite_manager_directx_12_delete_sprite, sprite_manager_directx_12_add_sprite, sprite_manager_directx_12_init_sprite_animation_pool, sprite_manager_directx_12_delete_sprite_animation, sprite_manager_directx_12_add_sprite_animation};
#endif
