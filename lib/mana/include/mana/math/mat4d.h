...
static const mat4d MAT4D_ZERO = {.data[0] = 0.0, .data[1] = 0.0, .data[2] = 0.0, .data[3] = 0.0, .data[4] = 0.0, .data[5] = 0.0, .data[6] = 0.0, .data[7] = 0.0, .data[8] = 0.0, .data[9] = 0.0, .data[10] = 0.0, .data[11] = 0.0, .data[12] = 0.0, .data[13] = 0.0, .data[14] = 0.0, .data[15] = 0.0};
static const mat4d MAT4D_IDENTITY = {.data[0] = 1.0, .data[1] = 0.0, .data[2] = 0.0, .data[3] = 0.0, .data[4] = 0.0, .data[5] = 1.0, .data[6] = 0.0, .data[7] = 0.0, .data[8] = 0.0, .data[9] = 0.0, .data[10] = 1.0, .data[11] = 0.0, .data[12] = 0.0, .data[13] = 0.0, .data[14] = 0.0, .data[15] = 1.0};

static inline mat4d mat4d_look_at(vec3d eye, vec3d center, vec3d up);
